...
<div className="mil-contact-container " id="contact">
    <div className="mil-contact-item">
        <h5 className="mil-contact-label">Email id:-</h5>
        <h5 className="mil-contact-value">muraliadapauxui@gmail.com</h5>
    </div>
    <div className="mil-contact-item">
        <h5 className="mil-contact-label">Phone number:-</h5>
        <h5 className="mil-contact-value">+91-9104103109</h5>
    </div>
</div>
        {/* map */}
